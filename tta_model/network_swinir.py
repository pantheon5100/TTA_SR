...
PRETRAINED_MODEL = {
    ...
    "classicalSR_s1_2": "001_classicalSR_DIV2K_s48w8_SwinIR-M_x2.pth",
    "classicalSR_s1_3": "001_classicalSR_DIV2K_s48w8_SwinIR-M_x3.pth",
    "classicalSR_s1_4": "001_classicalSR_DIV2K_s48w8_SwinIR-M_x4.pth",
    "classicalSR_s1_8": "001_classicalSR_DIV2K_s48w8_SwinIR-M_x8.pth",
    # (setting2: when model is trained on DIV2K+Flickr2K and with training_patch_size=64)
    "classicalSR_s2_2": "001_classicalSR_DF2K_s64w8_SwinIR-M_x2.pth",
    "classicalSR_s2_3": "001_classicalSR_DF2K_s64w8_SwinIR-M_x3.pth",
    "classicalSR_s2_4": "001_classicalSR_DF2K_s64w8_SwinIR-M_x4.pth",
...
def define_model(task, scale, model_type, training_patch_size=48, large_model=False)-> SwinIR:
    model_path = os.path.join("tta_pretrained", PRETRAINED_MODEL[model_type])
    # set up model
